...
function t1(min, max) {
    document.querySelector('.out-1').innerHTML = Math.floor(min + Math.random()*(max-min+1));
}
...
function t2(min, max, block) {
    block.innerHTML = Math.floor(min + Math.random()*(max-min+1));
}
...
function t3(min = 0, max = 100) {
    document.querySelector('.out-3').innerHTML = Math.floor(min + Math.random()*(max-min+1));
}
...
function t4(a, b, c) {
    ...
    if (b===0) out.innerHTML = c;
    else out.innerHTML = a/b;
}
...
function t11() {
    out11.innerHTML = [...arguments].reduce((a,b) => a+b);
}
...
function t12(...args) {
    out12.innerHTML = args.reduce((a,b) => a+b);
}
