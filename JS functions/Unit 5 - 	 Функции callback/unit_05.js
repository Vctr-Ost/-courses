...
let res4;
res4 = ar3.filter(i => typeof (i) == 'number' ? true : false); // сюда в скобки дописываете стрелочную функцию
...
let res6 = [];
ar5.forEach(i => res6.push(i.toLowerCase())); // сюда в скобки дописываете стрелочную функцию
...
let res8;
res8 = ar7.every(i => i > 10);// сюда в скобки дописываете стрелочную функцию
...
let res10;
res10 = ar9.some(i => typeof(i)==='boolean');// сюда в скобки дописываете стрелочную функцию
